	...
	<view :style='{"width":"100%","flexWrap":"wrap","background":"#ffffff","display":"flex","height":"100%"}'>
		...
		<!-- 商品列表 -->
			...
			<view class="title" :style='{"padding":"0 32rpx 0 32rpx","margin":"0 24rpx 24rpx 24rpx","borderColor":"#1d5dca","borderWidth":"0 0 0 8rpx","display":"flex","width":"calc(100% - 48rpx)","borderStyle":"solid","justifyContent":"space-between","height":"48rpx"}'>
				<view :style='{"fontSize":"36rpx","lineHeight":"48rpx","color":"#333333","fontWeight":"600"}'>医生</view>
				<text :style='{"color":"#666","fontSize":"28rpx","lineHeight":"48rpx"}' @tap="onPageTap('yisheng')">查看更多</text>
			</view>
		  ...
		  <view v-if="3 == 3" class="list-box style3" :style='{"width":"100%","padding":"24rpx 24rpx 24rpx 24rpx","margin":"0 0 0 0","height":"auto"}'>
			<view @tap="onDetailTap('yisheng',product.id)" v-for="(product,index) in homeyishenglist" :key="index" class="list-item" :style='{"boxShadow":"0 0px 0px #00000030","padding":"0 0 20rpx 0","margin":"0 0 40rpx 0","borderColor":"#eeeeee","flexWrap":"wrap","borderWidth":"0 0 2rpx 0","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"space-between","height":"auto"}'>
			  			  			  			  			  			  			  			  			  <image :style='{"width":"200rpx","margin":"0 20rpx 0 0","objectFit":"cover","borderRadius":"8rpx","display":"block","height":"200rpx"}' class="list-item-image" mode="aspectFill" v-if="product.zhaopian.substring(0,4)=='http'" :src="product.zhaopian"></image>
			  <image :style='{"width":"200rpx","margin":"0 20rpx 0 0","objectFit":"cover","borderRadius":"8rpx","display":"block","height":"200rpx"}' class="list-item-image" mode="aspectFill" v-else :src="product.zhaopian?baseUrl+product.zhaopian.split(',')[0]:''"></image>
			  			  			  			  			  			  			  			  			  			  			  			  			  			  			  			  			  <view class="list-item-body" :style='{"width":"calc(100% - 240rpx)","padding":"0 0 0 0","margin":"20rpx 0 0 0","height":"auto"}'>
				                				                				<view :style='{"padding":"0 20rpx 0 20rpx","margin":"0 0 12rpx","overflow":"hidden","whiteSpace":"nowrap","color":"#333333","borderRadius":"8rpx","background":"#ffffff","width":"100%","lineHeight":"60rpx","fontSize":"28rpx","textOverflow":"ellipsis","height":"60rpx"}' class="list-item-title">医生姓名:{{product.yishengxingming}}</view>
								                				                				                				<view :style='{"padding":"0 20rpx 0 20rpx","margin":"0 0 12rpx","overflow":"hidden","whiteSpace":"nowrap","color":"#333333","borderRadius":"8rpx","background":"#ffffff","width":"100%","lineHeight":"60rpx","fontSize":"28rpx","textOverflow":"ellipsis","height":"60rpx"}' class="list-item-title">{{product.keshi}}</view>
								                				                				                				                				                				<view :style='{"padding":"0 20rpx 0 20rpx","margin":"0 0 12rpx","overflow":"hidden","whiteSpace":"nowrap","color":"#333333","borderRadius":"8rpx","background":"#ffffff","width":"100%","lineHeight":"60rpx","fontSize":"28rpx","textOverflow":"ellipsis","height":"60rpx"}' class="list-item-title">{{product.shanzhanglingyu}}</view>
								                																																																																																																			  </view>
			</view>
		  </view>
		...
		<!-- 新闻资讯 -->
			...
			<view class="title" :style='{"padding":"0 32rpx 0 32rpx","margin":"0 24rpx 24rpx 24rpx","borderColor":"#1d5dca","borderWidth":"0 0 0 8rpx","display":"flex","width":"calc(100% - 48rpx)","borderStyle":"solid","justifyContent":"space-between","height":"48rpx"}'>
				<view :style='{"fontSize":"36rpx","lineHeight":"48rpx","color":"#333333","fontWeight":"600"}'>医院信息</view>
